...
public class TriObjectiveTopTrumpsStudyRQ23 extends TriObjectiveTopTrumpsStudy {
	...
	public TriObjectiveTopTrumpsStudyRQ23(){
		super(10,TriObjectiveTopTrumpsStudy.DEFAULT_BASE_DIRECTORY,"RQ23-ImpactOfTheNumberOfCardsToChooseFrom");
	}
	...
	protected List<ExperimentProblem<DoubleSolution>> generateProblemList() {
		...
		int[] values= {1,2,4,8,16,30};
		for(int nCardsToChooseFrom:values) {			
			problem=new TopTrumpsDeckGenerationProblem(ncards,categories,games,nrounds,players,nCardsToChooseFrom);
			problem.setProblemName(problem.getName()+"-"+String.valueOf(nCardsToChooseFrom));
			expProblem=new ExperimentProblem<>(
						problem,
						String.valueOf(nCardsToChooseFrom)
					);
	...
	public static void main(String[] args) throws IOException {
		TriObjectiveTopTrumpsStudy study=new TriObjectiveTopTrumpsStudyRQ23();
		study.run(args);
	}
