...
public class TriObjectiveTopTrumpsStudyRQ21bis extends TriObjectiveTopTrumpsStudy {
	...
	public TriObjectiveTopTrumpsStudyRQ21bis(){
		super(10,TriObjectiveTopTrumpsStudy.DEFAULT_BASE_DIRECTORY,"RQ21-ImpactOfTheNumberOfCardsPerDeckWith10Rounds");
	}
	...
	public static void main(String[] args) throws IOException {
		TriObjectiveTopTrumpsStudy study=new TriObjectiveTopTrumpsStudyRQ21bis();
		study.run(args);
	}
