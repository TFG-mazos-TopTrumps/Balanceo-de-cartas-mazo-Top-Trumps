...
public class TriObjectiveTopTrumpsStudyRQ24 extends TriObjectiveTopTrumpsStudy {
	...
	public TriObjectiveTopTrumpsStudyRQ24(){
		super(10,TriObjectiveTopTrumpsStudy.DEFAULT_BASE_DIRECTORY,"RQ24-ImpactOfTheNumberOfRounds");
	}
	...
	protected List<ExperimentProblem<DoubleSolution>> generateProblemList() {
		...
		for(int i=5;i<30;i++) {
			...
			problem.setProblemName(problem.getName()+"-"+String.valueOf(nrounds));
			expProblem=new ExperimentProblem<>(
						problem,
						String.valueOf(nrounds)
					);
	...
	public static void main(String[] args) throws IOException {
		TriObjectiveTopTrumpsStudy study=new TriObjectiveTopTrumpsStudyRQ24();
		study.run(args);
	}
