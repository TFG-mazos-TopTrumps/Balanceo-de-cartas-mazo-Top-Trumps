...
public class TriObjectiveTopTrumpsStudy {
	...
	public static void main(String[] args) throws IOException {
	    ...
	    Experiment<DoubleSolution, List<DoubleSolution>> experiment =
	            new ExperimentBuilder<DoubleSolution, List<DoubleSolution>>("MazoTopTrumpsTriObjetivoStudy")
	                    .setAlgorithmList(algorithmList)
	                    .setProblemList(problemList)
	                    .setExperimentBaseDirectory(experimentBaseDirectory)
	                    .setOutputParetoFrontFileName("FUN")
	                    .setOutputParetoSetFileName("VAR")
	                    .setReferenceFrontDirectory(experimentBaseDirectory + "/MazoTopTrumpsTriObjetivoStudy/referenceFronts")
