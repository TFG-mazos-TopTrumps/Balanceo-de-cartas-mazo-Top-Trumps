...
public class TriObjectiveTopTrumpsStudyRQ25 extends TriObjectiveTopTrumpsStudy {
	...
	public TriObjectiveTopTrumpsStudyRQ25(){
		super(10,TriObjectiveTopTrumpsStudy.DEFAULT_BASE_DIRECTORY,"RQ25-ImpactOfTheNumberOfPlayers");
	}
	...
	protected List<ExperimentProblem<DoubleSolution>> generateProblemList() {
		...
		int[] nplayers= {2,3,5,6};
		for(int players:nplayers) {			
			problem=new TopTrumpsDeckGenerationProblem(ncards,categories,games,nrounds,players,nCardsToChooseFrom);
			problem.setProblemName(problem.getName()+"-"+String.valueOf(players));
	...
	public static void main(String[] args) throws IOException {
		TriObjectiveTopTrumpsStudy study=new TriObjectiveTopTrumpsStudyRQ25();
		study.run(args);
	}
